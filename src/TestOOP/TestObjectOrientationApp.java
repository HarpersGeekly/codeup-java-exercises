...
/**
 * Created by RyanHarper on 1/16/17.
 */
public class TestObjectOrientationApp {
    public static void main(String[] args) {
        ...
        do {
            firstName = validator.getString("Enter Student's first name:");
            lastName = validator.getString("Enter Student's last name:");
        ...
        System.out.println("Now the App ends");
