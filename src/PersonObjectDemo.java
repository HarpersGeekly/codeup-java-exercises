...
public class PersonObjectDemo {
    public static void main(String[] args) {
        ...
        // create a new Person object based on the Person class:, and then two more people:

//        Person /*class*/ person1 /*variable*/ = new Person(); /*calls the object constructor (in Java has to have the same name remember?)*/
...
//        System.out.println(person3);
    ...
    public static Person getPerson(Scanner scan) {
        ...
        Person person = new Person(); //making a new Person object and it calls the constructor.
