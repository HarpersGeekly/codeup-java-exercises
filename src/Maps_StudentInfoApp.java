...
/**
 * Created by RyanHarper on 1/13/17.
 */
...
//        System.out.println(studentList);
    ...
    public static Map newStudent(Validator validator) {
        ...
        student.put("firstName", validator.getString("What is the students first name?"));
        student.put("lastName", validator.getString("What is the students last name?"));
